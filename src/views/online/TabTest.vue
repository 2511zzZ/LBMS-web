<template>
  <div class="page-header-index-wide">
    <top-cards :level="miniBarParams.level" :levelId="miniBarParams.levelId"></top-cards>
...
import { RankList, Bar, Trend, NumberInfo, MiniSmoothArea, STable, Ellipsis, TopCards } from '@/components'
import StepByStepModal from './modules/StepByStepModal'
import CreateForm from './modules/CreateForm'
import { mixinDevice } from '@/utils/mixin'
import "echarts/lib/component/title"
import { getTotalOnlineData, getBranchRank, getLastTotalOnlineData, getTotalHistoryData, getBranchHistoryRank, getBranchList } from '../../api/LBMSmanage'
  ...
  data () {
    return {
      ...
      loadData: () => {
        ...
        return getBranchList(parameters)
          .then(res => {
